...
import net.waspyarp.wyscarmory.item.custom.armor.crusader.ModCustomCrusaderDArmorItem;
...
public class CrusaderDArmorModel extends GeoModel<ModCustomCrusaderDArmorItem> {
    ...
    public ResourceLocation getTextureResource(ModCustomCrusaderDArmorItem animatable) {
        return new ResourceLocation(WYsCarmory.MOD_ID, "textures/armor/crusader_armor_diamond_layer_1.png");
    }
