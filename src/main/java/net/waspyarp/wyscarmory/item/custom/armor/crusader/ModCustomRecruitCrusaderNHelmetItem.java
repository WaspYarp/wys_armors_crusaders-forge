...
import net.waspyarp.wyscarmory.client.armor.crusader.RecruitCrusaderNHelmetRender;
...
public class ModCustomRecruitCrusaderNHelmetItem extends ModCustomArmorItem {

    public ModCustomRecruitCrusaderNHelmetItem(ArmorMaterial material, Type type, Properties properties) {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            private RecruitCrusaderNHelmetRender renderer;

            @Override
            public @NotNull HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack,
                                                                   EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
                if (this.renderer == null)
                    this.renderer = new RecruitCrusaderNHelmetRender();
