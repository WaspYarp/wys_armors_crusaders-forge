...
public class ModCustomSpartanNArmorItem extends ModCustomArmorItem {


    public ModCustomSpartanNArmorItem(ArmorMaterial material, Type type, Properties properties) {
